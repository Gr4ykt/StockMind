...
const ProductEdit = () => {
    const { getProduct, updateProduct, loading, errors } = useProducts();
        ...
        return (
            <div className="px-4 py-8 max-w-2xl mx-auto">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-6">El producto que intentas editar no existe o no tienes permisos para acceder a él.</p>
                    <button
